...
import AnonLog from "./LogingAWS";
import './Css/AllDataAWS.css';
import TableData from "./ShowDataTable";
import Loader from "./LoadingData";
  ...
  <div className="row">
    ...
    <div className="card-body-2" >
      ...
      Object.keys(dataAws).map((e :any , index :number)=>(
        ...
        dataAws!= null ?  e== "Landmarks" ? "aria-hidden = true" : e : "no connection or your image is not match"
        } 
        dataValue={JSON.stringify(
          dataAws[e] == "Emotions" ? Object.entries(dataAws[e]).map((e : any)=> JSON.stringify(dataAws[e].Type)) :
        ...
        dataConfidence={JSON.stringify(
          ...
          dataEmotions3={JSON.stringify(
            dataAws[e].Left != null ? "Left : "+dataAws[e].Left : ''
          )}
        />  
        ))       
        }  
